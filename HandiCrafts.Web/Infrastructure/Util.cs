...
namespace HandiCrafts.Web.Infrastructure
{
    ...
    {
        public const string BaseUrl = "https://service.saraycrafts.ir/";
        public const string Url = "https://service.saraycrafts.ir/api/Account/Customer_GetActivationCodeForLogin?userId=60&activationCode=1234";
